...
%    2. It is also assumed that the CRN has mass action kinetics.           %
%    3. The algorithm first decomposes the network intro its finest         %
...
%          [2].                                                             %
%    5. Translation of network comes from [3].                              %
%    6. Parametrization of steady state solution comes from [4].            %
%    7. Computation of directed spanning trees toward vertices come from    %
%          [1].                                                             %
%    8. Sometimes, when the solution could not be expressed in terms of     %
...
%    9. Ideas for some parts of the code was motivated by [5].              %
%                                                                           %
% References                                                                %
